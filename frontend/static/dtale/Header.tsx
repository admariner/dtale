...
const Header: React.FC<HeaderProps & WithTranslation> = ({
  ...
  if (columnIndex === 0) {
    return <DataViewerMenuHolder style={style} columns={columns} rowCount={rowCount} propagateState={propagateState} />;
  }
  ...
  if (settings.verticalHeaders) {
    ...
    textStyle.width =
      gu.getRowHeight(0, { backgroundMode, columns }, { verticalHeaders: settings.verticalHeaders, maxRowHeight }) - 15;
